 ...
 * TPX300 plane
 */
class PlaneTPX300 extends Plane {
    private String purpose;
    private String skeleton;
    private String engine;
    private String seats;

    public PlaneTPX300(String purpose, String skeleton, String engine, String seats) {
        try{
            System.out.println("Build process started for TPX300");
        ...
        System.out.println("TPX300 is ready.");
    }
